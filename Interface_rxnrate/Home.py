...
st.markdown(""" <style> html, body, [class^="css"] {font-family : 'Times New Roman', Times, serif;} h1, h2, h3, h4, h5, h6 
            {font-family : 'Times New Roman', Times, serif;} </style>""", unsafe_allow_html=True)
